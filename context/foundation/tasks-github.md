...
| S-05 | `user-settings` | [#14](https://github.com/mkozachuk/bitworth/issues/14) | [Slice] S-05: User settings — display currency & preferences | — | CLOSED |
| S-06 | `mobile-refactor` | [#15](https://github.com/mkozachuk/bitworth/issues/15) | [Slice] S-06: Mobile refactor — responsive UI pass (nav, buttons, forms) | — | CLOSED |
