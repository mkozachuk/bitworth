...
- [ ] 3.2 Linting passes including `react-compiler` on `DriftAlerts.tsx`
- [ ] 3.3 Build passes (`npm run build`)

#### Manual

- [ ] 3.4 With toggle off, no drift card appears
- [ ] 3.5 With toggle on and no cards/targets, no drift card appears
- [ ] 3.6 A card drifted ≥5pp shows the worst card, top offenders with correct signed over/under drift, and a working `/dashboard/balancer` link
- [ ] 3.7 Two drifting cards → worst shown in detail, other named in "Also drifting" note
- [ ] 3.8 A card with targets summing ≠100 shows the proportional-comparison note
- [ ] 3.9 All cards within threshold → card is absent
- [ ] 3.10 No regression to FIRE card, assets summary, or net-worth chart
